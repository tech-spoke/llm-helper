...
| enable_overlay | Parameter exists | **Removed** |
...
|--------|--------|------------|
| `start_session` `enable_overlay` removed | Parameter error | Remove parameter |
...
- [ ] Remove `enable_overlay` parameter
...
### Skill Prompt Update
- [ ] Remove overlay/branch from Step 2
- [ ] Add new Step 5
